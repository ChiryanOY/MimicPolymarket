...
console.log(
    `  ${colors.green}npm run setup${colors.reset}          Interactive configuration wizard`
);
console.log(`  ${colors.green}npm run health-check${colors.reset}   Verify everything is working`);
console.log(
    `  ${colors.green}npm run build${colors.reset}          Compile TypeScript to JavaScript`
);
...
console.log(
    `  ${colors.green}npm run check-allowance${colors.reset}   Verify USDC token allowance`
);
console.log(
    `  ${colors.green}npm run verify-allowance${colors.reset}  Validate allowance and wallet readiness`
);
console.log(
    `  ${colors.green}npm run set-token-allowance${colors.reset}  Set USDC spending approval`
);
console.log('');
...
console.log('');
console.log(
    `${colors.yellow}⚠️  Always start with small amounts and monitor regularly!${colors.reset}\n`
);
